...
export const STATUS_BADGE_CLASSES: Record<string, string> = {
  localModified: "bg-blue-500/10 text-blue-700",
  remoteChanged: "bg-violet-500/10 text-violet-700",
  bothChanged: "bg-red-500/15 text-red-700",
  localOnly: "bg-green-500/10 text-green-700",
  remoteOnly: "bg-violet-500/10 text-violet-700",
  notDownloaded: "bg-amber-500/10 text-amber-700",
  localDeleted: "bg-red-500/10 text-red-700",
  pendingEdit: "bg-blue-500/10 text-blue-700",
  pendingAdd: "bg-green-500/10 text-green-700",
  pendingDelete: "bg-red-500/10 text-red-700",
  pendingRename: "bg-blue-500/10 text-blue-700",
